...
const MapMenu: React.FunctionComponent<MapMenuProps> = ({census, toggleCensus, groupedEntries, toggleEntryGroup, highlightZoomEntity}) => {
    ...
    return <div className="map-menu">
        ...
        <div
            ...
            <div className="collapse-content">
                <ul>
                    {
                        groupedEntries.filter(ge => ge.items.length).map(ge => <li className="locality-option-li"
                            ...
                            <div
                                ...
                                <div className="collapse-title">
                                    <div  onClick={() => toggleLocality(ge.title, !localityOpen.includes(ge.title))}>
                                        <div className="img-container"><img src={parkIcon} alt="group-icon"
                                ...
                                <div className="collapse-content">
                                    ...
                                    {ge.items.map(item => <div className="locality-item"
                                        ...
                                        <h4 className="locality-item-title cursor-pointer" onClick={() => highlightZoomEntity(item)}>{item.name ?? ge.title}</h4>
