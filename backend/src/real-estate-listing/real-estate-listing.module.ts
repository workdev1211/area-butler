...
import { RealEstateListing, RealEstateListingSchema } from './schema/real-estate-listing.schema';

@Module({
    imports: [UserModule, MongooseModule.forFeature([{name: RealEstateListing.name, schema: RealEstateListingSchema}])],
