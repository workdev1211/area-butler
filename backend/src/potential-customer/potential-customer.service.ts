...
export class PotentialCustomerService {
  ...
  async insertPotentialCustomer(
    ...
    const currentNumberOfCustomers = (await this.fetchPotentialCustomers(user))
      .length;
    ...
    subscriptionCheck &&
      (await this.subscriptionService.checkSubscriptionViolation(
        user._id,
        subscription =>
          subscription?.limits?.numberOfCustomers &&
          currentNumberOfCustomers >= subscription?.limits?.numberOfCustomers,
