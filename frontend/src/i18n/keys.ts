export const IntlKeys = {
  ...
  potentialCustomers: {
    ...
    potentialCustomerSubmitSuccessful: "potentialCustomers.potentialCustomerSubmitSuccessful",
    potentialCustomerSubmitFailed: "potentialCustomers.potentialCustomerSubmitFailed",
