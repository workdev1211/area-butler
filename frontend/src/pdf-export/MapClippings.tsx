  ...
  return (<div className="m-10 flex flex-col gap-6" id="expose-map-clippings">
    <div>
      ...
      <div className="mt-5" style={imageSize}>
        <img style={imagePosition} src={nearbyClipping?.mapClippingDataUrl}></img>
      </div>
    </div>
    <div>
      <h1>Wie sieht es in der größeren Umgebung aus?</h1>
      <div className="mt-5" style={imageSize}>
        <img style={imagePosition} src={cityClipping?.mapClippingDataUrl}></img>
      </div>
    </div>
    <div style={imageSize}>
      <h1>Was erreiche ich ansonsten?</h1>
      <div className="mt-5">
        <img style={imagePosition} src={birdsEyeClipping?.mapClippingDataUrl}></img>
      </div>
    </div>
  </div>);
};
