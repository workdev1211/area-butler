...
const DefaultLayout: React.FunctionComponent<DefaultLayoutProps> = ({title, withHorizontalPadding, actionTop, actionBottom = [], children}) => {
    return (
        <div className="default-layout">
            <div className="default-layout-header">
                <h1>{title}</h1>
                {actionTop && <div className="dropdown z-2000" data-tour="actions-top">
                    ...
                    <ul tabIndex={0} className="sm:right-1 p-2 shadow menu dropdown-content bg-base-100 rounded-box w-72">
                        { actionTop }
                    </ul>
                </div>}
            </div>
